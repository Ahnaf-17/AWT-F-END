  ...
  <section class="mb-32 text-white-800">
    <div class="flex flex-wrap">
      <div class="grow-0 shrink-0 basis-auto mb-6 md:mb-0 w-full md:w-6/12 px-3 lg:px-6">
        <h4 class="text-3xl font-bold mb-6">Contact us</h4>
        <p class="text-white-500 mb-7">
Feel free to contact us. Our team will be reach you soon
        </p>
        <p class="text-white-500 mb-2">Dhaka Bangladesh</p>
        <p class="text-white-500 mb-2">+088018******</p>
        <p class="text-white-500 mb-2">coin_b@gmail.com</p>
      </div>
